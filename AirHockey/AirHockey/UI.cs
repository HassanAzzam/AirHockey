...
namespace AirHockey
{
    public class UI
    {
        ...
        {
            Vector2 Origin = this.App.SpriteFont.MeasureString(Text) / 2;
            this.App.SpriteBatch.DrawString(this.App.SpriteFont, Text, Position, Color, 0, Origin, Scale, SpriteEffects.None, 0.5f);
        }
        ...
        public void DrawBackground(Color Color, float Alpha)
        {
            ...
            this.App.SpriteBatch.Draw(
                Rectangle,
                new Rectangle(
                    0,
                    0,
                    this.App.Graphics.GraphicsDevice.Viewport.Width,
                    this.App.Graphics.GraphicsDevice.Viewport.Height),
                    Color.White);
        }
    }
}